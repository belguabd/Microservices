...
if(isset($_POST['submit'])){
    ...
    $nom = $_POST['name'];
    $req = $bd->prepare("UPDATE categories SET name=? ,image=?  WHERE  id=?");
    $req->execute([$nom,$image,$id]);
    header('location: /admin/categorie/index.php?msg=updated');
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="<?= $data['name'] ?>" type="text" name="name"
                                                            id="nom" class="form-control" placeholder=""
                                                  ...
                                                  <input type="file" name="image" id="image" class="form-control" 
                                                    ...
                                                    <div class="form-group">
                                                        <button name="submit"
                                                            class="btn btn-outline-info">Modifier</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
